...
export default function ChangePassword() {
    ...
    return (
        <div className="w-full h-4/6 flex items-start">
            <div className="flex h-auto flex-col items-center justify-center px-6">
                <h1 className="text-lg font-medium mb-8 w-full">Para crear una contraseña segura:</h1>
            ...
            <div className="w-1/2 h-full flex justify-center items-center">
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex w-4/6 flex-col gap-8">
                        <FormField
