                        ...
                        <div className="overflow-hidden border border-gray-200 ">
                            <table className="min-w-full divide-y divide-gray-200 ">
                                ...
                                <tr>
                                    ...
                                    <th scope="col"
                                        className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 ">Password
                                    </th>
                                ...
                                {fetchUsers.map((user) => (
                                    <TableRow user={user} key={user.id} setRefreshData={setRefreshData}
...
function TableRow({user, setRefreshData, refreshData}: {
    user: User,
    ...
    return (
        <tr>
            ...
            <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                <div
                    className={`inline-flex items-center px-3 py-1 rounded-full gap-x-2 ${user.status? "bg-emerald-100/60": "bg-red-100/60"}`}>
            ...
            <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{user.role}
            </td>
            <td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{user.password}</td>
            <td className="px-4 py-4 text-sm whitespace-nowrap">
                <div className="flex items-center gap-x-6">

                    <ModalConfirmDelete userId={user.id} userName={user.username}
                                        onUserDeleted={() => setRefreshData(!refreshData)}/>
