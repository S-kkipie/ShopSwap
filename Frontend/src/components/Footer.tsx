function Footer() {
    return (
        <footer className="bg-foreground mt-20 py-10">
        ...
        <div className="lg:flex">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    <div>
                        <h3 className="text-white font-semibold uppercase">About</h3>
                    ...
                    <div>
                        <h3 className="text-white font-semibold uppercase">Blog</h3>
                    ...
                    <div>
                        <h3 className="text-white font-semibold uppercase">Products</h3>
                    ...
                    <div>
                        ...
                        <span className="block mt-2 text-sm text-white hover:underline">example@email.com</span>
                    </div>
                </div>
            </div>
        </div>
